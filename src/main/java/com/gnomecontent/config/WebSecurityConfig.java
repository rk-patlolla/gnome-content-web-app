package com.gnomecontent.config;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable();
		http.authorizeRequests().antMatchers("/","/userInfo", "/userLogin", "/login", "/logout").permitAll();
		...
		http.apply(new SpringSocialConfigurer()).signupUrl("/userLogin");
	}
